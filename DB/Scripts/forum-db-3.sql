...
--
-- Host: db
-- Generation Time: Jan 16, 2026 at 04:41 PM
...
ALTER TABLE `POSTS`
  ...
  ADD KEY `fk_posts_topics` (`topicID`);
...
--
ALTER TABLE `TOPICS`
  MODIFY `topicID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `POSTS`
  ADD CONSTRAINT `fk_posts_topics` FOREIGN KEY (`topicID`) REFERENCES `TOPICS` (`topicID`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
